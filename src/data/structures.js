...
export const FAMILIES = {
  ...
  civic: {
    levels: [
      ...
      { service: 1.3, floors: 2, value: 2, slots: 2, look: { roof: 'slate' }, cost: M(0, { planks: 30, stone: 36, bricks: 20, glass: 6 }, 24) },
      { service: 1.45, floors: 2, value: 2.7, slots: 2, grow: 1, look: { wall: 'stone', roof: 'slate' }, cost: M(0, { planks: 36, stone: 50, bricks: 34, glass: 10 }, 32, { tech: ['masonry'] }) },
      { service: 1.6, floors: 2, value: 3.6, slots: 3, grow: 1, look: { wall: 'stone', roof: 'slate', flag: true }, cost: M(0, { planks: 40, stone: 64, bricks: 48, glass: 16, iron_ingot: 6 }, 40, { tech: ['masonry'] }) },
    ],
